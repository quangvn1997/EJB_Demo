 ...
 * 
 */
@WebServiceClient(name = "UserWebService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:43912/EJBBankAssignment-war/UserWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName USERWEBSERVICE_QNAME = new QName("http://service/", "UserWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:43912/EJBBankAssignment-war/UserWebService?WSDL");
    ...
    public UserWebService getUserWebServicePort() {
        return super.getPort(new QName("http://service/", "UserWebServicePort"), UserWebService.class);
    }
    ...
    public UserWebService getUserWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "UserWebServicePort"), UserWebService.class, features);
    }
